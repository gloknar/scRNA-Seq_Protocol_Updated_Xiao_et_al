...
args <- commandArgs()
tumor <- args[6]
outDir <- file.path("dataset",tumor,"intra_malignant")
...
selected_tumor_metabolic_sce$tumor <- factor(selected_tumor_metabolic_sce$tumor)
#=========================================================================
tumors <- factor(selected_tumor_sce$tumor)
tumors <- unique(tumors)
